...
<head>
	...
	<link href="<?= config_item('url_template'); ?>gentelella/vendors/pnotify/dist/pnotify.buttons.css"
		rel="stylesheet">
	<link href="<?= config_item('url_template'); ?>gentelella/vendors/pnotify/dist/pnotify.nonblock.css"
		rel="stylesheet">
	...
	<script
		src="<?= config_item('url_template'); ?>gentelella/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
	...
	<link href="<?= config_item('url_js'); ?>loadmask/jquery.loadmask.css" rel="stylesheet" type="text/css"
		media="screen" />
	<script type="text/javascript" src="<?= config_item('url_js'); ?>loadmask/jquery.loadmask.min.js"></script>
	<link href="<?= config_item('url_js'); ?>spinner/css/gspinner.css" rel="stylesheet" type="text/css"
		media="screen" />
	<script type="text/javascript" src="<?= config_item('url_js'); ?>spinner/js/g-spinner.js"></script>

	<link href="<?= config_item('url_js'); ?>datepicker/dist/css/bootstrap-datepicker.css" rel="stylesheet"
		type="text/css" media="screen" />
	<script type="text/javascript"
		src="<?= config_item('url_js'); ?>datepicker/dist/js/bootstrap-datepicker.js"></script>
	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<?php
				$this->load->view("pengajuan/v_content_cuti.php");
				?>
			</div>
			<!-- /page content -->
