...
<head>
	...
	<link rel="stylesheet" href="<?= config_item('url_js'); ?>timepicker/jquery.timepicker.min.css" />
	...
	<link href="<?= config_item('url_template'); ?>absensi/absensi.css" rel="stylesheet">
...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<?php
				$this->load->view("pengajuan/v_content_absensi.php");
				?>
			</div>
			<!-- /page content -->
	...
	<script src="<?= config_item('url_js'); ?>timepicker/jquery.timepicker.min.js"></script>
</body>
