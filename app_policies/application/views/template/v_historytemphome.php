...
<head>
	...
	<link href="<?php echo config_item('url_template'); ?>gentelella/vendors/pnotify/dist/pnotify.buttons.css"
		rel="stylesheet">
	<link href="<?php echo config_item('url_template'); ?>gentelella/vendors/pnotify/dist/pnotify.nonblock.css"
		rel="stylesheet">
	...
	<script
		src="<?php echo config_item('url_template'); ?>gentelella/vendors/pnotify/dist/pnotify.nonblock.js"></script>
	...
	<link href="<?php echo config_item('url_js'); ?>loadmask/jquery.loadmask.css" rel="stylesheet" type="text/css"
		media="screen" />
	<script type="text/javascript" src="<?php echo config_item('url_js'); ?>loadmask/jquery.loadmask.min.js"></script>
	<link href="<?php echo config_item('url_js'); ?>spinner/css/gspinner.css" rel="stylesheet" type="text/css"
		media="screen" />
	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<?php $this->load->view("template/v_historytemphome_content.php"); ?>
			</div>
			<!-- /page content -->
